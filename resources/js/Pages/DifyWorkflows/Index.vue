    ...
    <AppLayout :breadcrumbs="breadcrumbs">
        <div class="container mx-auto py-8">
            <div class="mb-6 flex items-center justify-between">
                ...
                <Button @click="$inertia.visit(difyWorkflows.create())"> <Plus class="mr-2 h-4 w-4" /> Add Workflow </Button>
            </div>
                            ...
                            <TableRow v-for="workflow in workflows" :key="workflow.id">
                                ...
                                <TableCell class="text-right">
                                    <div class="flex justify-end gap-2">
                                        <Button variant="outline" size="sm" @click="$inertia.visit(difyWorkflows.edit(workflow.id))">
                                            <Edit class="h-4 w-4" />
                                        </Button>
                                        <Button
                                            variant="destructive"
